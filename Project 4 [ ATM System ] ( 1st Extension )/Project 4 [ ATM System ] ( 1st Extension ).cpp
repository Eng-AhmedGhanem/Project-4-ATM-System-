...
void PerformQuickWithdrawOption(short QuicWithdrawOption)
{
	...
	if (DepositBalanceToClientByAccountNumber(CurrentClient.AccountNumber, vClients, WithDrawBalance * -1))
...
void PerformDepositOption()
{
	...
	if (DepositBalanceToClientByAccountNumber(CurrentClient.AccountNumber, vClients, DepositAmount))
